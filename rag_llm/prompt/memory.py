...
class Memory:
    ...
    def add_query(
        ...
        resp_list = [{'response': query['response']} for query in queries]
    ...
    def delete_query(self, ids: List[str], collection: str = DB_COMMAND_HISTORY):
        """
        delete: delete the memery collections.
        Args:
            collection_name: the name of the collection to delete.
        """
        return self.client.get_or_create_collection(collection).delete(
                    ids=ids
                )
